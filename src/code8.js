...
try {
    ...
    window.byted_acrawler.init({
        ...
        boe: !1,
        intercept: !0,
        enablePathList: ["/aweme/v1/*", "/aweme/v2/*"].concat( [])
    });
    debugger;
    var p = new XMLHttpRequest;
    p.open("GET", '/aweme/v1/web/aweme/post/?device_platform=webapp&aid=6383&channel=channel_pc_web&sec_user_id=MS4wLjABAAAAYsGlaAlC63EwxXFJX-DkIdIcMNr5PxZy3h3PvIGobBFp8S11I-0xQMQ2i-Z182vk&max_cursor=1612400400000&count=10&publish_video_strategy_type=2&version_code=160100&version_name=16.1.0&cookie_enabled=true&screen_width=2048&screen_height=1152&browser_language=zh-CN&browser_platform=Windows&browser_name=Mozilla&browser_version=5.0+(Windows+NT+10.1%3B+Win64%3B+x64)+AppleWebKit%2F537.36+(KHTML,+like+Gecko)+Chrome%2F90.0.4430.212+Safari%2F537.36&browser_online=true', !0);
    catvm.print.getall();
    debugger;
   p.send(null);
} catch (error) {
